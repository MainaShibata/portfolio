...
*****************************************************/
	...
	<article class="loop-entry clearfix">
		...
		<ul class="loop-entry-meta">
			<li class="loop-entry-meta-date"><i class="fa fa-clock-o"></i><?php _e('On','wpex'); ?> <?php the_time('j'); ?> <?php the_time('M'); ?>, <?php the_time('Y'); ?></li>
			<li class="loop-entry-meta-author"><i class="fa fa-user"></i><?php _e('By', 'wpex'); ?> <?php the_author_posts_link(); ?></li>
            <?php if( comments_open() ) { ?>
				<li class="loop-entry-meta-comments"><i class="fa fa-comments"></i><?php _e('With', 'wpex'); ?>  <?php comments_popup_link('0 Comments', '1 Comment', '% Comments'); ?></li>
            <?php } ?>
		</ul><!-- /loop-entry-meta -->
		<?php } ?>
